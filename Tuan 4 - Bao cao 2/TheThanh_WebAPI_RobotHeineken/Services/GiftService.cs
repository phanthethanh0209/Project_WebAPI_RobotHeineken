...
namespace TheThanh_WebAPI_RobotHeineken.Services
{
    ...
    {
        Task<IEnumerable<GiftDTO>> GetAllGift(int pageNumber = 1);
    ...
    public class GiftService : IGiftService
    {
        ...
        public async Task<IEnumerable<GiftDTO>> GetAllGift(int pageNumber)
        {
            IEnumerable<Gift> gifts = await _repository.Gift.GetAllWithPaginationAsync(null, pageNumber, PAGE_SIZE);
