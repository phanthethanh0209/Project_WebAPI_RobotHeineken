...
namespace TheThanh_WebAPI_RobotHeineken.Services
{
    ...
    {
        Task<IEnumerable<RecyclingHistoryDTO>> GetAllMachineHistory();
    ...
    public class RecyclingHistoryService : IRecyclingHistoryService
    {
        ...
        public async Task<IEnumerable<RecyclingHistoryDTO>> GetAllMachineHistory()
        {
            IEnumerable<RecyclingHistory> histories = await _repository.RecyclingHistory.GetAllAsync();
